...
import styles from './PricingPackages.module.css'; // Используем новые стили

// Данные для карточек тарифов (можно вынести в отдельный файл, но пока оставим здесь)
const packagesData = [
  {
    title: "LAUNCH",
    setupPrice: "C$3,000",
  ...
  return (
    <section className={styles.pricingSection}>
      <div className="container">
        <h2 className={styles.sectionTitle}>Pricing</h2> {/* Измененный заголовок */}
